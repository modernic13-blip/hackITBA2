            ...
            {user ? (
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center p-2.5 bg-card border border-border rounded-full text-muted-foreground hover:text-red-500 hover:bg-red-500/10 transition-colors shadow-sm"
                        title="Cerrar Sesión"
                    >
                        <LogOut size={18} />
                    </button>
